...
rt_err_t drv_spi_init(void)
{
    ...
    /* attach spi_device_1 to spi1 */
    {
        ...
        stm32_spi_cs_1.GPIO_Pin = GPIO_Pin_2;
    ...
    /* attach spi_device_2 to spi1 */
    {
        ...
        stm32_spi_cs_2.GPIOx = GPIOE;
        stm32_spi_cs_2.GPIO_Pin = GPIO_Pin_15;
    ...
    /* attach spi_device_3 to spi1 */
    {
        ...
        stm32_spi_cs_3.GPIOx = GPIOC;
        stm32_spi_cs_3.GPIO_Pin = GPIO_Pin_15;
    ...
    /* attach spi_device_1 to spi2 */
    {
        ...
        stm32_spi_cs_4.GPIOx = GPIOD;
        stm32_spi_cs_4.GPIO_Pin = GPIO_Pin_7;
        ...
        ret |= rt_spi_bus_attach_device(&rt_spi_device_4, "spi2_dev1", "spi2", (void*)&stm32_spi_cs_4);
    }
