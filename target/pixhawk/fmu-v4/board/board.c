...
void bsp_initialize(void)
{
    ...
    /* init imu0 */
    RT_CHECK(drv_icm20600_init("spi1_dev3", "gyro0", "accel0"));
    /* init imu1 + mag0 */
    RT_CHECK(mpu6000_drv_init("spi1_dev1", "gyro1", "accel1"));
//     // RT_CHECK(lsm303d_drv_init("spi1_dev1", "mag0", "accel1"));
    /* init barometer */
    RT_CHECK(drv_ms5611_init("spi2_dev1", "barometer"));
...
#ifdef FMT_USING_CM_BACKTRACE
    /* cortex-m backtrace */
    cm_backtrace_init("fmt_fmu-v4", TARGET_NAME, FMT_VERSION);
#endif
